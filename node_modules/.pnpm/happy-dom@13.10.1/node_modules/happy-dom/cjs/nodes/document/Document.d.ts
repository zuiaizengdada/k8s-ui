...
import IHTMLAnchorElement from '../html-anchor-element/IHTMLAnchorElement.cjs';
/**
 * Document.
 */
export default class Document extends Node implements IDocument {
     ...
     */
    get links(): INodeList<IHTMLAnchorElement | IHTMLElement>;
    /**
     * Returns a collection of all form elements in a document.
     */
    get forms(): INodeList<IHTMLFormElement>;
    /**
     * Last element child.
     *
     * @returns Element.
