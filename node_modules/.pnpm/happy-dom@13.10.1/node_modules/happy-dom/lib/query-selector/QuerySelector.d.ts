...
export default class QuerySelector {
     ...
     */
    static querySelectorAll<K extends keyof IHTMLElementTagNameMap>(node: IElement | IDocument | IDocumentFragment, selector: K): INodeList<IHTMLElementTagNameMap[K]>;
    /**
     * Finds elements based on a query selector.
     *
     * @param node Node to search in.
     ...
     * @returns HTML elements.
     */
    static querySelectorAll<K extends keyof ISVGElementTagNameMap>(node: IElement | IDocument | IDocumentFragment, selector: K): INodeList<ISVGElementTagNameMap[K]>;
    /**
     * Finds elements based on a query selector.
     *
     * @param node Node to search in.
     ...
     */
    static querySelector<K extends keyof IHTMLElementTagNameMap>(node: IElement | IDocument | IDocumentFragment, selector: K): IHTMLElementTagNameMap[K] | null;
    /**
     * Finds an element based on a query selector.
     *
     * @param node Node to search in.
     ...
     * @returns HTML element.
     */
    static querySelector<K extends keyof ISVGElementTagNameMap>(node: IElement | IDocument | IDocumentFragment, selector: K): ISVGElementTagNameMap[K] | null;
    /**
     * Finds an element based on a query selector.
     *
     * @param node Node to search in.
